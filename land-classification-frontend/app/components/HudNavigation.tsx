...
export default function HudNavigation() {
  ...
  return (
    <header className="w-full bg-[#0b0f19]/80 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50 px-4 md:px-8 py-3.5 flex flex-col sm:flex-row items-center justify-between gap-4">
      {/* Brand logo */}
