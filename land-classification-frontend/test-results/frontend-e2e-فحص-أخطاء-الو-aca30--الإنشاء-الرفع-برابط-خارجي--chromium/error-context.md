...
- Name: frontend-e2e.spec.js >> فحص أخطاء الواجهة الأمامية (Frontend E2E Error Monitor) >> 2. فحص عملية الإنشاء (الرفع برابط خارجي)
- Location: tests\frontend-e2e.spec.js:112:3
